<?php
$cepDestinoPost = trim($_POST['cep_destino']);
$cepOrigemPost = trim($_POST['cep_origem']);
$valorPostProduto = trim($_POST['valor_produto']);

function calculaFrete(
      $cod_servico = "SEDEX10", /* codigo do servico desejado */
   ...
   $resultado = calculaFrete("SEDEX10", $cepOrigemPost, $cepDestinoPost, 5, 5, 2,4, $valorPostProduto);